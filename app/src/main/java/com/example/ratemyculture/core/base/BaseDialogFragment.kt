...
abstract class BaseDialogFragment<T: ViewDataBinding, V: BaseFragmentViewModel<*>, K:BaseDelegate>: DialogFragment(), BaseNavigator {
...
//        mViewModel = viewModel
    ...
    override fun showAlert(
        ...
        buttonThree: String?,
        buttonThreeListener: DialogInterface.OnClickListener?
    ) {
        delegate?.showAlert(
            title,
            message,
